...
/**
 *  \file       sorderplus/class/fournisseur.commande.release.class.php
...
/**
 *	Class to manage table commandefournisseurrelease
 */
class CommandeFournisseurRelease extends CommonObject
{
	public $db;							//!< To store db handler
	public $error;							//!< To return error code (or message)
	public $errors=array();				//!< To return several error codes (or messages)
	public $element='commandefournisseurrelease';			//!< Id that identify managed objects
	public $table_element='commande_fournisseur_release';		//!< Name of table without prefix where object is stored
	public $lines=array();
